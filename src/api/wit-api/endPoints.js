...
export const outfitCount = 'outfit/count'
export const updateProfilePhoto = 'user/update-profile-photo'
export const updateUser = 'user/update'
export const updateLink = 'outfit/links'
export const filterUsers = 'user/filter'
